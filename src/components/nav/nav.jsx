...
const Nav = () => {
  ...
  return (
    <>
      <div className="w-full bg-[#F0F2F5] py-1">
        <div className="max-w-[1255px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div
              onClick={openModal}
              className="font-medium flex gap-1 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-[#8E4DFF] text-[15px] font-medium">
              Sotuvchi bo'lish
            </a>
            <a href="#" className="text-[#8E4DFF] text-[15px] font-medium">
              Topshirish punktini ochish
            </a>
            <a href="#" className="text-[#4D4F59] text-[15px] font-medium">
              Savol-javob
            </a>
            <a href="#" className="text-[#4D4F59] text-[15px] font-medium">
              Buyurtmalarim
      ...
      {modal && <CityModal onClose={closeModal} />}
    </>
  );
};
